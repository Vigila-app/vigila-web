...
- **LEVELS**
    ...
    - **GOD**: is the highest level a user can achieve, but it is limited justo to ADMIN role (currently not in use).
- **ROLES**
    ...
    - **ADMIN**: is the highest and powerful role, but it's not available. No one can signup with this role. It's a role reserved to Vigila Staff.
