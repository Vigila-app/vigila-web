...
export const AvailabilityRulesDemo = () => {
  ...
  const rulesByWeekday = useMemo(() => {
    ...
    Object.keys(grouped).forEach((key) => {
      grouped[Number(key)].sort((a, b) => a.start_time.localeCompare(b.start_time));
    });
    return grouped;
  }, [rules, weekdays]);
        ...
        <div className="flex items-start justify-between">
          <div>
            <div className="flex items-center gap-2">
              ...
              <h2 className="text-lg font-semibold text-slate-900">Giorni e orari</h2>
            </div>
              ...
              <div key={day.value} className="py-4">
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-3">
                    ...
                    <span className="text-sm font-semibold text-slate-900">{day.labelIT}</span>
                  </div>
                  <button
