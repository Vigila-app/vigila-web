           ...
           return <div>
              ...
              <div className="flex flex-wrap gap-4 mt-2">
                {question.options?.map((option, idx) => {
                  ...
                  const isLastOdd =
                    question.options.length % 2 === 1 && idx === question.options.length - 1;
                  return (
                    <div
                      key={option.value}
                      className={clsx(
                        "cursor-pointer p-2 border-2 border-grey-200 rounded-3xl py-3 flex-1 min-w-[45%] max-w-[calc(50%-0.5rem)]",
