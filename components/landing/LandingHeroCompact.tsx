...
const LandingHeroCompact = ({
  ...
  return (
    <section className={clsx("relative overflow-hidden bg-gradient-to-b from-[#ffe7de] via-[#fff1eb] to-white px-4 pb-12 pt-4", className)}>
      <div className="mx-auto flex max-w-5xl flex-col gap-8 lg:flex-row lg:items-center lg:gap-12">
        <div className="flex-1 text-center lg:text-left">
          <h1 className="text-3xl font-bold leading-[1.15] text-gray-900 sm:text-4xl">{headline}</h1>
          <p className="mx-auto mt-3 max-w-md text-sm leading-relaxed text-gray-600 lg:mx-0">
            {description}
          </p>
        ...
        <div className="flex flex-1 justify-center lg:justify-end">
          <div className="relative h-[340px] w-[260px] overflow-hidden rounded-[1.5rem] bg-white shadow-xl sm:h-[400px] sm:w-[300px]">
