    ...
    <div className={bgColor}>
      <div className="flex flex-col items-center bg-gray-50 min-h-screen pb-10">
        <div className="mx-auto max-w-xl text-center">
          ...
          <h2 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">PERCHÉ VIGILA È NECESSARIA?</h2>
          ...
          <div className="mx-auto max-w-2xl p-6 mt-12 shadow-lg rounded-xl">
            <div className="p-0">
              <h3 className="text-xl font-bold mb-4">Con Vigila trasformiamo questi numeri in opportunità:</h3>
         ...
         <div className="text-center space-y-4 mb-16">
          <h2 className="text-4xl font-bold tracking-tighter sm:text-5xl md:text-6xl">Come iniziare con Vigila</h2>
          <p className="text-lg ">Tre semplici passi per trovare il tuo Vigil</p>
          ...
          <div className="mt-12 space-y-8">
            <div className="flex flex-col items-center space-y-4">
              ...
              <h3 className="text-2xl font-bold text-vigil-orange">Per le Famiglie</h3>
              <p className="text-md  max-w-sm">Trovare un amico speciale per il tuo caro</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              ...
              <div className="flex flex-col items-center text-center space-y-2">
                ...
                <p className="text-lg font-medium">Trova un vigil vicino a te</p>
                <p className="text-sm">cerca nella tua zona e visualizza i profili disponibili</p>
              </div>
              {/* Step 2 Famiglie */}
              <div className="flex flex-col items-center text-center space-y-2">
                <div className="w-10 h-10 rounded-full bg-vigil-orange text-white flex items-center justify-center text-lg font-bold">
                ...
                <p className="text-lg font-medium">Scegli chi ti ispira fiducia</p>
                <p className="text-sm ">Leggi recensioni e seleziona il Vigil più adatto</p>
              </div>
              {/* Step 3 Famiglie */}
              <div className="flex flex-col items-center text-center space-y-2">
                <div className="w-10 h-10 rounded-full bg-vigil-orange text-white flex items-center justify-center text-lg font-bold">
                ...
                <p className="text-sm ">Prenota e inizia subito il servizio di cui hai bisogno</p>
              </div>
            </div>
          </div>
          ...
          <div className="mt-12 space-y-8">
            <div className="flex flex-col items-center space-y-4">
              ...
              <h3 className="text-2xl font-bold text-consumer-blue">Per i Giovani</h3>
              <p className="text-md max-w-sm">Trovare un amico speciale per il tuo caro</p>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
              {/* Step 1 Giovani */}
              <div className="flex flex-col items-center text-center space-y-2">
                ...
                <p className="text-sm">Raccontaci i tuoi interessi e cosa ti piace fare</p>
              </div>
              {/* Step 2 Giovani */}
              <div className="flex flex-col items-center text-center space-y-2">
                <div className="w-10 h-10 rounded-full bg-consumer-blue text-white flex items-center justify-center text-lg font-bold">
                ...
                <p className="text-sm">conosci anziani meravigliosi con storie da raccontare</p>
              </div>
              {/* Step 3 Giovani */}
              <div className="flex flex-col items-center text-center space-y-2">
                <div className="w-10 h-10 rounded-full bg-consumer-blue text-white flex items-center justify-center text-lg font-bold">
                ...
                <p className="text-sm">Scopri quanto è bello imparare l'uno dall'altro</p>
              </div>
            </div>
          </div>
        </div>
