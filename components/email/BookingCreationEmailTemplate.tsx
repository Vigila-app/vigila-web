...
export function BookingCreationEmailTemplate(
  ...
  return (
    ...
    >
      <EmailHeader
        title={
          isVigil ? `Nuova Prenotazione Assegnata ✅` : `Prenotazione Creata ✅`
        }
        subtitle={undefined}
      />
      ...
      >
        ...
        {!isVigil && (
          ...
          >
            Il Vigil dovrà confermare la disponibilità prima che la prenotazione
            sia attiva.
            <br />
            Ti preghiamo di controllare i dettagli della prenotazione qui sotto.
          </p>
        )}
        <br />
        <div
        ...
        >
          ...
          >
            {isVigil ? (
              <>
                <li>
                  Controlla i dettagli della prenotazione e conferma la tua
                  disponibilità
                </li>
                <li>
