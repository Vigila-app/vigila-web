...
interface BookingCreationEmailProps {
  customerName: string;
  bookingId: string;
  serviceName: string;
...
export function BookingCreationEmailTemplate(
  {
    customerName,
    bookingId,
    serviceName,
  ...
  return (
    ...
    >
      <EmailHeader
        title={isVigil ? `Nuova Richiesta ✅` : `Prenotazione Creata ✅`}
      />
        ...
        {isVigil ? (
          <>
            ...
            >
              ...
              <br />
              clicca il link per visualizzare le tue prenotazioni, accettare o
              rifiutare (se accetti ti contattiamo per organizzare tutto) 🚀
            </p>
          ...
          <>
            ...
            >
              Il Vigil dovrà confermare la disponibilità prima che la
              prenotazione sia attiva.
              <br />
              Ti preghiamo di controllare i dettagli della prenotazione qui
              sotto.
            </p>
            <br />
            <div
            ...
            >
              ...
              >
                <li>
                  Controlla i dettagli della prenotazione e assicurati che siano
                  corretti
                </li>
                <li>
