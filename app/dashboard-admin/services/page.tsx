  ...
  return (
    <div className="space-y-6">
      <div>
        ...
        <p className="text-gray-600">Visualizza e gestisci tutti i servizi disponibili sulla piattaforma</p>
      </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <div className="text-center">
            <p className="text-3xl font-bold text-purple-600">
              €{services.reduce((avg, s) => avg + s.price, 0) / services.length || 0}
            </p>
            ...
            <tbody className="bg-white divide-y divide-gray-200">
              {filteredServices.map((service) => (
                <tr key={service.id}>
                  ...
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="text-sm text-gray-900">{service.total_bookings}</div>
                  </td>
                  <td className="px-6 py-4 whitespace-nowrap">
                    <div className="flex items-center">
                      <div className="text-sm font-medium text-gray-900">{service.average_rating}/5</div>
                    ...
                    <div className="flex space-x-2">
                      ...
                      {service.status === 'active' && (
                        <button
                          ...
                          onClick={() => handleStatusUpdate(service.id, 'inactive')}
                        >
                          Disattiva
                        </button>
                      )}
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Servizi più Prenotati</h3>
                ...
                <div key={service.id} className="flex justify-between items-center">
                  <div className="flex items-center">
                    ...
                    <div>
                      ...
                      <p className="text-xs text-gray-500">€{service.price} - {service.category}</p>
                    </div>
                  </div>
                  <p className="text-sm font-bold text-blue-600">{service.total_bookings} prenotazioni</p>
                </div>
              ))}
          </div>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          <h3 className="text-lg font-medium text-gray-900 mb-4">Servizi Meglio Valutati</h3>
          <div className="space-y-3">
            {services
              ...
              .map((service, index) => (
                <div key={service.id} className="flex justify-between items-center">
                  <div className="flex items-center">
                    ...
                    <div>
                      <p className="text-sm font-medium text-gray-900">{service.name}</p>
                      <p className="text-xs text-gray-500">{service.total_bookings} prenotazioni</p>
                    </div>
                  </div>
                  <div className="flex items-center">
                    <p className="text-sm font-bold text-yellow-600 mr-1">{service.average_rating}/5</p>
