...
type EmailRequest = WelcomeEmailRequest | BookingConfirmationRequest | NotificationEmailRequest;
...
//       case 'notification': {
//         const { to, subject, content } = body as NotificationEmailRequest;

//         // Validazione dei campi obbligatori
//         if (!subject || !content) {
//           return NextResponse.json(
//             { error: 'Campi obbligatori mancanti: subject e content sono richiesti per le email di notifica' },
//             { status: 400 }
//           );
//         }
